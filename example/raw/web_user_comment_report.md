## 一、系统描述
这是一个非常简单的系统的威胁模型示例 - 基于网络的评论系统。用户输入评论，这些评论被添加到数据库并显示给用户。人们的想法是，尽管很简单，但这是一个足以表达有意义威胁的完整例子。
...
![](web_user_comment_dfd.png)

### 数据流列表

|Name|From|To |Data|Protocol|Port|
| ---- | ---- | ---- | ---- | ---- | ---- |
|数据库验证用户真实身份|SQL数据库|真实身份数据库|验证用户身份的令牌|RDA-TCP|40234|
|用户输入评论 (*)|用户|Web服务器|在HTML或Markdown中的用户评论数据|HTTP|80|
|包含用户评论数据的Insert查询指令|Web服务器|SQL数据库|包含用户评论数据的Insert查询指令|MySQL|3306|
|检索评论|SQL数据库|Web服务器|Web服务器从DB检索评论|MySQL|80|
|展示评论 (*)|Web服务器|用户|Web服务器向最终用户显示评论|HTTP|-1|
|Serverless功能定期清理数据库|AWS功能区|SQL数据库|Serverless功能清除数据库|MySQL|3306|
...
| ---- | ---- | ---- |
|验证用户身份的令牌||SECRET|
|在HTML或Markdown中的用户评论数据||PUBLIC|
|包含用户评论数据的Insert查询指令||PUBLIC|
|Web服务器从DB检索评论||PUBLIC|
|Web服务器向最终用户显示评论||UNKNOWN|
|Serverless功能清除数据库||PUBLIC|
...
<details>
  <summary>   DS06   --   Data Leak</summary>
  <h6> Targeted Element </h6>
  <p> 数据库验证用户真实身份 </p>
  <h6> Severity </h6>
  <p>Very High</p>
...
<details>
  <summary>   DR01   --   Unprotected Sensitive Data</summary>
  <h6> Targeted Element </h6>
  <p> 数据库验证用户真实身份 </p>
  <h6> Severity </h6>
  <p>High</p>
